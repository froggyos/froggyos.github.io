    ...
    fileSystem: {
        ...
        "D:/Programs": [
            ...
            { name: "test", properties: {read: true, write: false, hidden: false}, data: [
                ...
                "int tsStart = 4",
                "int tsEnd = 26",
                'outc {t=c01} "this is blu\'v:woof\'e text"',
                'outc {b=c00} "this is a black background"',
                'outc {t=v:var, b=c01} "this is green green text on a blue background"',
                'outc {t=c01, tr=0-16} "from the 1st to 17th character, the text will be blue"',
                'outc {t=c01, tr=v:tsStart-v:tsEnd | b=c04, br=57-72} "from the 5th to 29th character, the text will be blue. AND from the 58th to the 73rd character the background will be red"',
                "endprog"
            ] },
            ...
            { name: "kaerugotchi", properties: {read: true, write: true, hidden: false}, data: [
                ...
                "        if {v:energy > 1 && v:currentEmotion != 'sleepy'}",
