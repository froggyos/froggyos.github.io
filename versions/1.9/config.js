...
const ENGLISH_LOCAL = [
    ...
    "list . . . . . . . . . . . . . Lists files and subdirectories in the current :sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp::sp:directory.",
...
const config = {
    ...
    fileSystem: {
        "Config:": [
            ...
            { name: "updateStatBar", properties: {read: true, write: true, hidden: false}, data: ["false"] }, // true
        ...
        "Config:/lang_files": [
            ...
            { name: "nmt", properties: {read: true, write: true, hidden: false}, data: [
                ...
                "clearstate. . . . . . . . ngátiwi froggyOS satéte",
                ...
                "list. . . . . . . . . . . seyaya fiyala me nam dilekatülilala ilo dilekatüli :sp::sp::sp::sp:wa",
                "listdrives. . . . . . . . seyaya ká'ono dalayavu me",
                "loadstate . . . . . . . . nagyu froggyOS satéte",
