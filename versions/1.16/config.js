...
const FroggyFileSystem = new fs({
    ...
    "D:/Programs": [
        ...
        { name: "test", properties: {transparent: true, read: true, write: true, hidden: false }, data: [
            ...
            { name: "fs3help", properties: {transparent: true, read: true, write: true, hidden: false }, data: [
                ...
                "        out '~~~~'",
                "        out 'Description: ' + commandObject.command.'description'",
                "        out '      Usage: ' + commandObject.command.'usage'",
                "        out '    Example: ' + commandObject.command.'example'",
                "    }",
                "    catch {",
                "        out ''",
                ...
                "    }",
                "    try {",
                "        out '       Note: ' + commandObject.command.'note'",
                "    }",
                "    quietkill",
                "}",
                "# no command specified, show general help",
                "out 'visit the documentation (docs command) to get more detailed information.'",
                "out 'Alternatively, pass the command name as a file argument to get help on a specific command.'",
                "out ''",
