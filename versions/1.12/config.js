...
const config = {
    ...
    fileSystem: {
        "Config:": [
            ...
            { name: "version", properties: {transparent: false, read: true, write: true, hidden: false}, data: ["1.12-indev"] },
        ...
        "D:/Programs": [
            ...
            { name: "test", properties: {transparent: true, read: true, write: true, hidden: false}, data: [
                ...
                "createscreen 78 57",
                "rect alertBkgd = $0, 57, 5, 1$",
                "text alertText = $0, 57, 'ALERT'$",
                "text alertText2 = $5, 57, ' - Program escaped.'$",
                "#alertBkgd>stroke('c03')>render",
                "#alertText>color('c15')>render",
                "#alertText2>color('c02')>render",
                "wait 10000000000000",
            ...
            { name: "loop-test", properties: {transparent: true, read: true, write: true, hidden: false}, data: [
                ...
                "num quickloopTest = 0",
                "num dummy = 0",
                "num loopStartTime = Time_MsEpoch",
                "loop loopTest < 1000",
                "set loopTest = loopTest + 1",
                "endloop",
