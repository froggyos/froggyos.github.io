    ...
    fileSystem: {
        ...
        "C:/Programs": [
            ...
            { name: "test", permissions: {read: true, write: true, hidden: false}, data: [
                ...
                "str promptOptionVariable = ''",
                "loop { true }",
                "    out 'Choose an option: '",
                "    prompt promptOptionNumber promptOptionVariable uno два three",
                "    if {v:promptOptionVariable == 'uno'}",
                "        out 'You chose uno'",
                "        set promptOptionNumber = 0",
                "    endif",
                "    if {v:promptOptionVariable == 'два'}",
                "        out 'You chose два'",
                "        set promptOptionNumber = 1",
                "    endif",
                "    if {v:promptOptionVariable == 'three'}",
                "        out 'You chose three'",
